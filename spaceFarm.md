...
小惑星や大型居住コロニーであれば地上と同様の環境を整えて…となるがここでは小規模長期滞在型コロニーや長距離移動型宇宙船での使用を想定したい。

冒頭の項目［宇宙農業の必要性］にて解説したとおり、大型建造物組み立てや惑星入植時には必要な作業中に滞在する宿泊施設（飯場）や長距離長期間輸送が必要なためである。
...
ここでは重要な作物であるエダマメに適した栽培カートリッジを考察したい。
...
しかし、ユニットそのものの重量計算において水を含む水循環ユニットの重量が大半を占めていたため、再考察となった。
...
水循環ユニットを外せば、その数値を達成できる。

## 第二案　物理法則の壁
<img alt="picture 51" src="images/6ec4517537d205b72a7f03232d57112864d427aca2222629063ff07d6458a663.png" width="200" />  

水循環ユニットを省略するため、武者鎧を活用し上下反転してLEDユニットの冷却を試みた。更に栽培ユニットは気密性を考慮していないため冷却と空気循環の為下部にファンユニットを付け上部から排気するようにした。

しかしバルーン内を１気圧とするとユニットの素材重量がかさむため耐圧を考えて再考察となった。

|バルーン直径m|バルーン表面積m3|バルーン厚さm|比重|バルーン重量t|材質|破断強度MPa|気圧|圧力(Pa)|張力(kgf/cm)|
|:----|:----|:----|:----|:----|:----|:----|:----|:----|:----|
|10|314|0.002|1.1|0.6908|スチレンブタジエンゴム|25|1|101330|5169.89795918367|
|10|314|0.0018|7.85|4.43682|鋼鉄S45C|7038|1|101330|5744.33106575964|
|10|314|0.0018|1.3|0.73476|ポリカーボネート|60|0.06|6079.8|344.659863945578|
|10|314|0.0018|1.3|0.73476|ポリウレタン|100|0.06|6079.8|344.659863945578|
|10|314|0.0018|1.3|0.73476|ポリプロピレン|40|0.06|6079.8|344.659863945578|
|10|314|0.0018|1.3|0.73476|和紙＋こんにゃく|525|0.06|6079.8|344.659863945578|
...
栽培プラント（メタルネットバルーンプラント）内部の気圧をバルーン材質の都合上低下（0.1気圧）そのため栽培ユニット内部（0.5気圧）との内圧差が生じるようになった。

それを考慮して圧力に強いシリンダー型としたが、内圧差により蓋やシリンダーそのものが飛び出す可能性があるため再考察となった。

|シリンダ直径m|シリンダ表面積m3|シリンダ厚さm|比重|シリンダ重量t|材質|破断強度MPa|気圧|圧力(Pa)|張力(kgf/cm)|
|:----|:----|:----|:----|:----|:----|:----|:----|:----|:----|
|0.25|0.3925|0.00335|1.1|0.0014463625|AS|82|0.52|52691.6|80.2491623515078|
|0.25|0.3925|0.00335|1.3|0.0017093375|塩化ビニル|50|0.52|52691.6|80.2491623515078|
|0.25|0.3925|0.00335|1.4|0.001840825|PET|73|0.52|52691.6|80.2491623515078|
|0.25|0.3925|0.00335|1.44|0.00189342|ケブラー|2920|0.52|52691.6|80.2491623515078|
...
しかしねじ切り部含め内圧差に強度が足りない・重量がかさむとのことで再考察となった。
...
当然総統も代案を考えていたようで、時間と労力その他リソースが尽きたため総統の代案を書き起こした。

硬質素材による再利用を考えた構造を考慮していたが思い切って使い捨て前提の構造とし、メンテナンスや収穫の度にロール状のパウチを引き出して上部を加熱圧着することで圧力に耐える構造とする。
...
## 闘い終わって…
エダマメ一つ栽培ユニットを最適化するだけでこれだけ仕様が変わり栽培プラントの構造にも影響を与えた。
...
以上を踏まえて今回はビール酵母を使用した。パン酵母を使用したレシピはHMにて試作する。
...
また栄養成分的には前項［宇宙で生産する作物］項にて算出したカロリー及びタンパク質を一食当たりで下回った。大豆より産生される大豆油を25g、ダイズミートを30g、エダマメを40g
加えれば充当できるだろう。

あと味付けに醤油を使い更に味噌を加えてしまった。やはり調味料が塩と塩こうじのみでは筆者のような日本人には厳しい。

地上から軽量なものは持ち込めるという前提で麹菌や納豆菌、スパイス類を持ち込み栽培できるものは栽培して納豆味噌醤油などを発酵生成という流れにする必要があると感じる。
